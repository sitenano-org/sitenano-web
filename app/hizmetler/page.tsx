        ...
        <div className="hizmetler-content-wrapper" style={{ marginLeft: '280px', display: 'flex', flexDirection: 'row', width: '100%', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            >
              ...
              {/* Ana içerik */}
              <div className="ai-strategy-content" style={{ position: 'relative', zIndex: 1, textAlign: 'left', display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%', marginTop: '40px' }}>
                <div style={{
                  fontFamily: 'Sora, Arial, Helvetica, sans-serif',
                  fontSize: '25px',
                  fontStyle: 'normal',
                ...
                <div style={{
                  ...
                  <div style={{ marginTop: '16px' }}>Görünmek, satmak, etkilemek ya da dönüştürmek için bize ulaşın.</div>
                </div>
                <button 
            ...
            {selected === 0 && (
              <>
                <h2 style={{
                  ...
                  Özel Ai Çözümleri - Fikirden Üretime
                </h2>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
                  ...
                  "Yapay Zeka" Sadece Teknoloji Değil, Yeni Bir Düşünme Biçimidir.
Yapay zeka artık bir seçenek değil, iş dünyası için kaçınılmaz bir gerçek.
Fakat bu alan çoğu işletme için hâlâ karmaşık, belirsiz ve "büyük oyuncuların alanı" gibi görünüyor. Biz bu algıyı değiştirmek için çalışıyoruz.
Yapay zeka, sadece dev şirketlerin değil; doğru adımlarla başlayan her ölçekten işletmenin dönüşüm aracıdır.
                </div>
                {/* AI Çözümleri Bölümü */}
                <div style={{ 
                  fontFamily: 'Sora, Arial, Helvetica, sans-serif', 
                ...
                <div style={{ 
                  ...
                  • Minimum Viable Product (MVP) seviyesinde AI tabanlı ürün fikirlerini hayata geçiriyoruz.
                </div>
                <div style={{ 
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif', 
                  fontSize: '16px', 
                  ...
                  • İş süreçlerinizi analiz ediyor, manuel adımları otomasyona dönüştürüyoruz.
                </div>
                <div style={{ 
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif', 
                  fontSize: '16px', 
                  ...
                  • Süreç takibi, veri analizi, tahminleme, öneri sistemleri gibi alanlarda çözümler geliştiriyoruz.
                </div>
                <div style={{ 
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif', 
                  fontSize: '16px', 
            ...
            {selected === 1 && (
              <>
                ...
                <div style={{
                  ...
                  Sadece Kod Yazmak Değil, Başından Sonuna Bir Yol Haritası Belirlemek.
                </div>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
                  ...
                  Bugüne kadar farklı sektörlere birçok web ve mobil proje oluşturduk. Kimisi başarıyla yayına alındı, kimisi farklı sebeplerle durdu. Ama hepsinden kazanılan net bir şey var:<br />Her proje, ya hayata geçer ya da bir sonraki projeye bilgi bırakır ve biz bu bilgiyle büyüdük, geliştik, yön değiştirdik.<br /><br />
                </div>
                <h3 style={{
                  fontFamily: 'Sora, Arial, Helvetica, sans-serif',
                  fontSize: '28px',
                  ...
                  Geçmişte Kalan Teknolojilerle Geleceği Kuramayız
                </h3>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
                  ...
                  Teknoloji dünyasında bazı şeyler çok hızlı eskir:<br />Kod yapıları, mimari modeller, kullanıcı alışkanlıkları ve iş akışları…<br />Bugünün projeleri artık sadece "çalışıyor olması" ile değerlendirilmiyor.<br />Artık sorular şunlar:<br /><br />• Ne kadar hızlı geliştirilebiliyor?<br />• Ne kadar ölçeklenebilir?<br />• Kullanıcı geri bildirimlerine ne kadar hızlı yanıt verebiliyor?<br />• Sistemin sürdürülebilirliği ne kadar mümkün?<br />• Yapay zekâ ile ne kadar entegre?<br />• Yarın başka bir teknolojiye evrildiğinde adapte olabilecek mi?<br /><br />İşte biz bu soruları merkeze alarak çalışıyoruz.<br /><br />
                </div>
                <h3 style={{
                  fontFamily: 'Sora, Arial, Helvetica, sans-serif',
                  fontSize: '28px',
                  ...
                  Proje Geliştirme Sürecinde Nasıl İlerliyoruz?
                </h3>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
                  ...
                  • Fikri Korumakla Başlıyoruz:<br />Her proje bir fikirdir. Koddan önce o fikir üzerine düşünür, nereye evrilebileceğini konuşuruz.<br />• Teknolojiyi Amaç Değil, Araç Görürüz:<br />İlla şu framework, bu yazılım dili, şu kütüphane olsun diye değil; projeye en uygun, sürdürülebilir teknolojiyle ilerleriz.<br />• MVP Mantığıyla Geliştiririz:<br />Hızlı deneyip, hızlı öğrenmek gerekir. Projenizi tüm detaylarıyla sıfırdan inşa etmek yerine, önce çekirdeği çalıştırırız.<br />• Adaptasyon Planları Oluştururuz:<br />Bir proje yayına girdikten sonra asıl iş başlar. Güncellenebilirlik, kullanıcı geri bildirimlerine göre evrimleşme ve olası pivot senaryolarını planlarız.<br /><br />
                </div>
                <h3 style={{
                  fontFamily: 'Sora, Arial, Helvetica, sans-serif',
                  fontSize: '28px',
                  ...
                  Web & Mobil Projelerin Geleceği Nereye Gidiyor?
                </h3>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
                  ...
                  Eskiden masaüstüyle başlanan projeler, sonra mobile uyarlanırdı.<br />Şimdi süreç tersine döndü:<br /><br />Mobil öncelikli, API merkezli, entegrasyona açık ve modüler yapılar artık standart haline geldi.<br />Yeni nesil projelerde dikkat ettiğimiz bazı temel noktalar:<br /><br />• Mobil öncelikli düşünme: Mobilde çalışmayan hiçbir fikir artık ölçeklenebilir değil.<br />• Modüler yazılım mimarileri: Projeler artık tek bir platformda sabit kalmıyor.<br />• Gerçek zamanlı veri akışı: Kullanıcılar beklemiyor, her şey anlık olmalı.<br />• AI ve veri entegrasyonu: Proje ne kadar veriyle konuşuyorsa, o kadar uzun ömürlü.<br />• Sürekli güncellenebilirlik: Kodun kendisi kadar, güncellenme kültürü de önemli.
                </div>
                <div style={{
                  fontFamily: 'Manrope, Arial, Helvetica, sans-serif',
                  fontSize: '16px',
