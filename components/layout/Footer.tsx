        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-heading font-bold">Sitenano</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Modern web çözümleri, yapay zeka araçları ve e-ticaret platformları ile işinizi dijital dünyada büyütün.
            </p>
          ...
          {/* Hizmetler */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">Hizmetler</h3>
          ...
          {/* Şirket */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">Şirket</h3>
            <ul className="space-y-3">
          ...
          {/* İletişim */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">İletişim</h3>
